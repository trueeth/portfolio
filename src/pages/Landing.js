...
import QUERIES, { Main, Midi, Heading, Full, Image, Paragraph } from '../theming/styles';
import styled from 'styled-components';
import { Nav, Foot, Project } from '../components';
import { Spread } from '../components/switch/styles';
import { Awk1, EA1Image } from '../images';
    ...
    <Main
      ...
      <Midi style={{ mixBlendMode: 'difference' }}>
        <Heading
          ...
          <span style={{ fontWeight: 300 }}>UX Engineer</span> crafting beautiful
          <span style={{ fontStyle: 'italic' }}> digital</span> user experiences
        </Heading>
      </Midi>
      <Full>
      ...
      <Midi>
        <Split>
          ...
          <Paragraph>
            As a UX Engineer, I have the design thinking and visual expertise of a designer, as well
            as the technical skills of a frontend software engineer. <br /> <br />
